"""
Django settings for Clothing ecommerce project.
...
SECRET_KEY = 'django-insecure-+dsccfreaxbcy1(eb9wz#c9y2irrix%z$c%g^55bg7=0bnlwx!'
...
AUTH_USER_MODEL = 'epark_app.CustomUser'
...
WSGI_APPLICATION ='e_parking.wsgi.application'
...
DJANGO_SETTINGS_MODULE = 'e_parking.settings.development'
